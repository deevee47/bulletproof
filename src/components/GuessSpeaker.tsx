  ...
  return (
    <div className='text-white min-h-screen flex justify-center items-center py-16 relative overflow-hidden'>
      <div className='w-full max-w-3xl px-4 relative z-10'>
        <div className="size-full w-full items-center justify-center overflow-hidden pt-8 mb-12">
          <BoxReveal boxColor={"#fbd38d"} duration={0.5}>
            <p className="text-7xl font-semibold bg-clip-text text-transparent bg-gradient-to-b from-gray-200 via-gray-400 to-gray-600 [text-shadow:_1px_1px_1px_rgb(0_0_0_/_20%)]">
              Guess Our Speakers
            </p>
          </BoxReveal>
        </div>
