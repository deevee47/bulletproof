...
function PreviousBulletProof() {
  return (
    <div className="flex flex-col md:flex-row items-center justify-between w-full px-4 md:px-8 lg:px-16 mb-5"> {/* Stack on mobile, flex row on larger screens */}
      <div className="flex flex-col items-start z-[999] w-full md:w-1/2"> {/* Full width on mobile */}
